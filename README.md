...
An attempt to produce circular phylogenetic tree with matplotlib. Based on the [biopython](https://biopython.org) [Phylo](https://biopython.org/wiki/Phylo) library. 
